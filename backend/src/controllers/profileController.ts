...
const getProfile = async (req: Request, res: Response) => {
    try {
        const profile : ProfileDocument | null = await Profile.findById(req.params.id);
...
const updateProfile = async (req: Request, res: Response) => {
    try {
        const updatedProfile : ProfileDocument | null = await Profile.findByIdAndUpdate(req.params.id, req.body, { new: true });
